...
import { deserializeHtml } from '../../components/Wysiwig/deserializeHtml'
import { RichTextEditor } from '../../components/Wysiwig/RichTextEditor'
import { serializeHtml } from '../../components/Wysiwig/serializeHtml'
...
export const VacancyForm = () => {
  ...
  const onSubmit = (data: VFormInputs) => {
    console.log(data)
    const html = serializeHtml({ children: data.jobDescription })
    console.log(html)

    const obj = deserializeHtml(new DOMParser().parseFromString(html, 'text/html').body)
    console.log(obj)
  }
    ...
    <>
      <div className='basis-3/5'>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className={`${ringBlock}`}>
            ...
            <p>Add some context to your Vacancy page by providing your company name, a job title and and job summary.</p>
            ...
            <label className='block mt-4'>
              <span className='text-gray-700'>Redirect to external application / website</span>
              <input
                {...register('appLink')}
          ...
          <div className={`${ringBlock}`}>
            ...
            <span className='text-gray-700'>Job requirements / description</span>
            {/* <RTextEditor /> */}
          ...
          <div className={`${ringBlock}`}>
            ...
            <label className='block mt-4'>
              ...
              <input
                ...
                className='mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500'
              />
              <p className='text-red-500 text-sm'>{errors.companyPic?.message}</p>
            </label>
          ...
          <button type='submit' className='w-full bg-green-800 text-white p-2 rounded-lg mt-2 hover:bg-green-900'>
            Generate QR Code
          </button>
        </form>
      </div>
      <div className='basis-2/5'>
        <div className='bg-white md:mt-0 md:w-90 md:ml-10 rounded-lg p-5 mt-10'>
          ...
          <button className='w-full bg-green-800 text-white cursor-pointer p-2 rounded-lg mt-2 hover:bg-green-900'>Save QR Code</button>
        </div>
      </div>
    </>
  )
